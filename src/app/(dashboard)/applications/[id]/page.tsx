...
export default async function ApplicationDetailPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-4  sm:px-2">
      <nav className="mb-2">
      ...
      <header className="flex flex-row items-center gap-3">
        ...
        >
          <span className="hidden sm:block">View job posting</span>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              {app.location && (
                <Fact icon={<MapPin className="size-4" />}>{app.location}</Fact>
              )}
            </CardContent>
          </Card>
